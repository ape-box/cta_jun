...
* Let `mount` know to start the database connection by `require`-ing cta-jun.db.core in some other namespace.
...
Request middleware functions are located under the `cta_jun.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `cta-jun.dev-middleware` namespace found in
